...
#define CASE_LABEL(x) case x: return #x;
	...
	CASE_LABEL(MSG_META_BEGIN_CAMERA_PITCH_UP)
	CASE_LABEL(MSG_META_END_CAMERA_PITCH_UP)
	CASE_LABEL(MSG_META_ALT_BEGIN_CAMERA_PITCH_UP)
	CASE_LABEL(MSG_META_ALT_END_CAMERA_PITCH_UP)
	CASE_LABEL(MSG_META_BEGIN_CAMERA_PITCH_DOWN)
	CASE_LABEL(MSG_META_END_CAMERA_PITCH_DOWN)
	CASE_LABEL(MSG_META_ALT_BEGIN_CAMERA_PITCH_DOWN)
	CASE_LABEL(MSG_META_ALT_END_CAMERA_PITCH_DOWN)
	CASE_LABEL(MSG_META_CAMERA_RESET)
	CASE_LABEL(MSG_META_CAMERA_PITCH_RESET)
	CASE_LABEL(MSG_META_ALT_CAMERA_PITCH_RESET)
